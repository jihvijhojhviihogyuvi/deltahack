...
(function () {
  ...
  function createUI() {
    ...
    document.addEventListener("keydown", (e) => {
      const isCtrlI = e.ctrlKey && !e.altKey && !e.shiftKey && e.key.toLowerCase() === "i";
      if (isCtrlI) {
        e.preventDefault();
        e.stopPropagation();
        scanPage();
  ...
  function showApiKeySetup() {
    ...
    resultDiv.innerHTML = `
      <div class="result-header">
        <span>Deltahack v0.2 Setup</span>
      ...
      <div class="result-footer">
        <span>DogeUB - <a id="discord-link">discord.gg/unblocking</a>  |  Ctrl+I to scan | Ctrl+E to quick hide</span>
      </div>`;
